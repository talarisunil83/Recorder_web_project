...
// video is actually captured as 

captureBtnCont.addEventListener("click",(e)=>{
    captureBtnCont.classList.add("scale-capture"); // adding animation
...
let timerID;
let counter=0; //represents totalb seconds
...
function startTimer(){
    ...
    function displayTimer(){
        ...
        how to calculate the time
           ...
           2) when ever this function display timer is called then we need to increment the
